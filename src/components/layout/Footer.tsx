    ...
    <footer className="border-t border-white/10 bg-[#120400] text-slate-400 py-10 px-6 font-mono text-xs">
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-6 text-slate-400">
          ...
          <Link href="/goals" className="hover:text-amber-400 transition">Goals</Link>
          <Link href="/finance" className="hover:text-amber-400 transition">Finance</Link>
          <Link href="/skills" className="hover:text-amber-400 transition">Skills</Link>
          <Link href="/agents" className="hover:text-amber-400 transition">Agents</Link>
        </div>
